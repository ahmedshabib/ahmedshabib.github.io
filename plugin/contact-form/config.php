<?php
		define('CONTACT_FORM_TO_NAME','Ahmed Shabib');
		define('CONTACT_FORM_TO_EMAIL','reachshabib@gmail.com');
		...
		define('CONTACT_FORM_SUBJECT','Contact Me:');
		...
		define('CONTACT_FORM_SEND_MSG_OK','Thank you for contacting me.Will get back to you ASAP.');
